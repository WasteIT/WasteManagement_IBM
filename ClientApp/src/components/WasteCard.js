...
export default function WasteCard(cardType) {
  return (
    <Link to='/graph' style={{textDecoration: 'none'}} state={{ name: cardType }}>
        <Card style={{
        width: '18rem',
        ...
        <Card.Img variant="top" src={`./images/${cardType.name}.png`} style={{
            width: '9rem',
